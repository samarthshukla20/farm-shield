...
export default function DashboardHome({ setActiveTab }) {
  ...
  const features = [
    ...
    {
      id: 'pest', // We will link this to the scan modal later
    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      <div className="glass-panel p-8 rounded-3xl relative overflow-hidden group">
        ...
        <div className="relative z-10">
          <h2 className="text-3xl font-bold mb-2 text-white">Farm Overview</h2>
          ...
          <div className="flex gap-4 mt-6">
            <div className="flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 border border-white/10">
              ...
              <span className="text-sm">Madhya Pradesh, IN</span>
            </div>
            <div className="flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 border border-white/10">
        ...
        {features.map((item) => {
          ...
          return (
            <button 
              ...
              className="glass-panel p-6 rounded-3xl text-left transition-all duration-300 hover:bg-white/10 hover:scale-[1.02] group"
            >
              <div className="flex justify-between items-start mb-4">
                ...
                <div className="p-2 rounded-full bg-white/5 group-hover:bg-white/20 transition">
                  <ArrowRight size={20} className="text-white/50 group-hover:text-white" />
                </div>
              </div>
